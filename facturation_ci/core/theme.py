...
# Couleurs
BG_DARK = "#f1f5f9"      # Fond principal (Bleu-gris très foncé)
BG_CARD = "#ffffff"      # Fond des cartes/panneaux (Bleu-gris moyen)
BG_SIDEBAR = "#ffffff"   # Fond de la barre latérale (Encore plus foncé)
PRIMARY = "#ff9e1d"      # Orange SOGICI
PRIMARY_HOVER = "#e68a19"
TEXT_MAIN = "#334155"    # Blanc cassé pour le texte principal
TEXT_SEC = "#64748b"     # Gris clair pour le texte secondaire
BORDER = "#cbd5e1"       # Bordures subtiles
SUCCESS = "#10b981"      # Vert
DANGER = "#ef4444"       # Rouge
...
/* ToolButton with Menu specific padding */
